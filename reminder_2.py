...
#        tk.Label(top, text="是否进入30分钟倒计时?", font=tkFont.Font(family="Lucida Grande", size=32)).pack()
...
#root.geometry('500x200')  # Adjust the size according to your content and font size.
#
#app = App(root)
#
#root.mainloop()
